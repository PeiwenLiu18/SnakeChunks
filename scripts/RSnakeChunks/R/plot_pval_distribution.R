...
#' PlotPvalDistrib.MultiTestTable(multitest.result, draw.lambda="line")
#'
PlotPvalDistrib.MultiTestTable <- function(multitest.result,
  ...
  p.values <- multitest.result$multitest.table$p.value

  ## Plot the histogram
  distrib <- hist(p.values,
