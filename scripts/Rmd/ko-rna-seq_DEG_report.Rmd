...
BoxplotsPerSample(all.counts.log2, stats.per.sample, xlab = "log10(counts)", 
              main = "log2(counts)")

## Boxplot of stdcounts
BoxplotsPerSample(stdcounts, stats.per.sample, xlab = "std counts", 
              main = "Standardized counts")

## Boxplot of log10-transformed stdcounts
BoxplotsPerSample(stdcounts.log2, stats.per.sample, xlab = "log10(std counts)", 
