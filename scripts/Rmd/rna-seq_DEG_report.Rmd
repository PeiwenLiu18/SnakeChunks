...
BoxplotsPerSample(all.counts, sample.desc, 
              xlab="Raw counts", 
              main="Raw counts per sample")

## Boxplot of log10-transformed counts
BoxplotsPerSample(all.counts.log10, sample.desc,  xlab="log10(counts)", 
              main="log10(counts) per sample")

## Boxplot of CPMs
BoxplotsPerSample(cpms, sample.desc, xlab="CPM", 
              main="CPMs per sample")

## Boxplot of log10-transformed CPMs
BoxplotsPerSample(cpms.log10, sample.desc, xlab="log10(CPM)", 
